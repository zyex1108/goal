...
int main()
{
  ...
  auto p1 = new_point2(Vector{1,0,0});
  auto p2 = new_point2(Vector{3,0,0});
  auto p3 = new_point2(Vector{3,3,0});
  auto p4 = new_point2(Vector{0,3,0});
  auto p5 = new_point2(Vector{0,1,0});
